...
//   const tdclient = new TiledeskChatbotClient({request: req, APIKEY: '____APIKEY____'})
  ...
  console.log('cbclient print-----',cbclient)
...
app.post("/microlang-bot/:botid", (req, res) => {
  const tdclient = new TiledeskChatbotClient({APIURL:'https://ncchatbot.signitydemo.in/api/',APIKEY:'__APIKEY__', request: req});
  ...
  .then(function(result) {
    ...
    if(res.statusCode === 200) {
      ...
      if(msg  == "Thank you, one of our Business Consultants will contact you shortly. If you would like to book an appointment please check here (calendly link) \agent"){
        msg = msg.substr(6)
      }
