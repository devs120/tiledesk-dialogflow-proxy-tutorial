...
app.post("/microlang-bot/:botid", (req, res) => {
  const tdclient = new TiledeskChatbotClient({APIURL:'https://ncchatbot.signitydemo.in/dashboard/#/project/620cd79e6d88b8001ab356ea/home',APIKEY:'__APIKEY__', request: req});
